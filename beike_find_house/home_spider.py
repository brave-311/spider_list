...
def get_home_url(page):
    url = f'http://bj.ke.com/ershoufang/pg{page}/'
    headers = {
    ...
    return html.xpath('//ul[@class="sellListContent"]//li[@class="clear"]/a/@href')
...
def main(page):
    ...
    for url in urls:
        print(f'开始爬去详细网页为{url}的房屋详细信息资料！')
